...
void Menu::Render(ShaderProgram *program) {
    Util::DrawText(program, Util::LoadTexture("font1.png"), "Escapist", 1, -0.5, glm::vec3(-2.0f, 1.0f, 0));
    Util::DrawText(program, Util::LoadTexture("font1.png"), "By Faisal Karim", 1, -0.5, glm::vec3(-3.25f, 0.0f, 0));
